...
class EditOrderPage extends StatefulWidget {
  const EditOrderPage({Key? key}) : super(key: key);
                      ...
                      BlocBuilder<CustomerBloc, CustomerState>(
                        builder: (context, state) {
                          if (state.customerList != null) {
                            ...
                            return Center(
                              child:
                                  Text(LocaleKeys.errors_failedLoadData.tr()),
                            );
                          } else {
                            return const Center(
                              ...
                              BlocBuilder<ProductsBloc, ProductsState>(
                                builder: (context, state) {
                                  if (state.productList != null) {
                                    ...
                                    double? productTotalPrice = mainFunctions
                                        .productTotalPriceCalculator(
                                      ...
                                      children: [
                                        ...
                                        ListTile(
                                          title: Text(LocaleKeys
                                              ...
                                              .tr()),
                                          subtitle: Text(productTotalPrice
                                              .toStringAsFixed(2)),
                                          style: ListTileStyle.drawer,
                                        ),
                                        ListTile(
                                          title: Text(LocaleKeys
                                              .order_orderProductNote
                                              .tr()),
                                          subtitle: Text(

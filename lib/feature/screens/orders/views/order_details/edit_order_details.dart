                    ...
                    BlocBuilder<CustomerBloc, CustomerState>(
                      builder: (context, state) {
                        if (state.customerList != null) {
                          final customer =
                              state.customerList?.customers.firstWhere(
                            ...
                            child: Column(
                              children: [
                                ...
                                ListTile(
                                  ...
                                  subtitle:
                                      SelectableText(customer?.adress ?? ''),
                                  style: ListTileStyle.drawer,
                                ),
                              ],
                            ),
                            ...
                            BlocBuilder<ProductsBloc, ProductsState>(
                              builder: (context, state) {
                                if (state.productList != null) {
                                  final product =
                                      state.productList?.products.firstWhere(
                                    (element) =>
                                        element.id ==
                                  ...
                                  return ExpansionTile(
                                    ...
                                    children: [
                                      ...
                                      ListTile(
                                        title: Text(
                                          LocaleKeys.order_productUnitPrice
                                              .tr(),
                                        ),
                                        subtitle: Text(
                                      ...
                                      ListTile(
                                        title: Text(
                                          LocaleKeys.order_orderProductNote
                                              .tr(),
                                        ),
                                        subtitle: Text(

    ...
    switch (settings.name) {
      ...
      case NavigationConstants.userProfile:
        return normalNavigate(
            const UserProfile(), NavigationConstants.userProfile);
      case NavigationConstants.registerPage:
        return normalNavigate(
            const SignUpWidget(), NavigationConstants.registerPage);
      //Drawer
      ...
      case NavigationConstants.productListPage:
        return normalNavigate(
            const ProductListPage(), NavigationConstants.productListPage);
      case NavigationConstants.courierAddPage:
        return normalNavigate(
            const AddCourier(), NavigationConstants.courierAddPage);
      case NavigationConstants.courierListPage:
        return normalNavigate(
            const CourierListPage(), NavigationConstants.courierListPage);
      //Orders
      case NavigationConstants.orderDetailsPage:
        return normalNavigate(
            const OrderDetails(), NavigationConstants.orderDetailsPage);
      case NavigationConstants.orderEditPage:
        return normalNavigate(
            const EditOrderPage(), NavigationConstants.orderEditPage);
      case NavigationConstants.orderAddCustomer:
        return normalNavigate(
            const AddOrderAddCustomer(), NavigationConstants.orderAddCustomer);
      case NavigationConstants.orderListCompletedOrders:
        return normalNavigate(const CourierListPage(),
            NavigationConstants.orderListCompletedOrders);
      case NavigationConstants.orderListOnTheWayOrders:
        return normalNavigate(const CustomerListPage(),
            NavigationConstants.orderListOnTheWayOrders);
      case NavigationConstants.orderListPendingOrders:
        return normalNavigate(
            const AddCourier(), NavigationConstants.orderListPendingOrders);
      ...
      case NavigationConstants.customerAddPage:
        return normalNavigate(
            AddCustomer(), NavigationConstants.customerAddPage);
      case NavigationConstants.customerListPage:
        return normalNavigate(
            const CustomerListPage(), NavigationConstants.customerListPage);
      case NavigationConstants.customerFlutterMap:
        return normalNavigate(const AddCustomerFlutterMap(),
            NavigationConstants.customerFlutterMap);
      case NavigationConstants.customerGoogleMap:
        return normalNavigate(
            AddCustomerGoogleMap(), NavigationConstants.customerGoogleMap);
      //Authentication
